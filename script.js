document.addEventListener('DOMContentLoaded', () => {
  ...
  const backToMainFromChemBtn = document.getElementById('back-to-main-from-chem-btn');
  const backToMainFromPhysicsBtn = document.getElementById('back-to-main-from-physics-btn');


  // Login Logic
  if (loginForm && loginContainer && mainContainer && passwordInput && errorMessage) {
